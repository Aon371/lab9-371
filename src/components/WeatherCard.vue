      ...
      <div class="row d-flex justify-content-center align-items-center h-100">
        ...
        <div class="card" style="color: #4B515D; border-radius: 35px;" >
            ...
            <div class="d-flex flex-column text-center mt-5 mb-4">
              <h6 class="display-4 mb-0 font-weight-bold" style="color: #2c3546;"> {{ (((i.main.temp - 32) / 1.8) / 6).toFixed(2) }}°C </h6>
...
.card {
  ...
  border: none;
  border-radius: 35px;
  box-shadow: 0px 15px 20px rgb(125, 125, 125);
  overflow: hidden;
  position: relative;
  z-index: 1;
}
...
.card:hover {
  box-shadow: 0px 15px 20px rgba(240, 168, 232, 0.731);
}
.card{
  margin-bottom: 50px;
}
